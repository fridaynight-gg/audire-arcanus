...
const SCHEDULE_AHEAD_TIME = 0.2; // Schedule audio 200ms ahead
...
function queueAudioBuffer(audioBuffer) {
  ...
  // Initialize nextPlayTime if not set or if we've fallen too far behind
  if (nextPlayTime === 0 || nextPlayTime < currentTime) {
    // Start playing slightly in the future to avoid underruns
